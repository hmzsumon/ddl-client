...
export const VideoIcon = ({ h, w, color }: Props) => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			width='32'
		...
		>
			<path
				fill='currentColor'
				fill-rule='evenodd'
				d='M6.55 10.8A3.25 3.25 0 0 1 9.8 7.55h13a3.25 3.25 0 0 1 3.25 3.25v7a3.25 3.25 0 0 1-3.25 3.25h-13a3.25 3.25 0 0 1-3.25-3.25zm4.128 11.75H9.8a4.75 4.75 0 0 1-4.75-4.75v-7A4.75 4.75 0 0 1 9.8 6.05h13a4.75 4.75 0 0 1 4.75 4.75v7a4.75 4.75 0 0 1-4.75 4.75h-.878q.126.354.128.75a2.25 2.25 0 0 1-2.25 2.25h-7a2.25 2.25 0 0 1-2.122-3m2.122 0a.75.75 0 0 0 0 1.5h7a.75.75 0 1 0 0-1.5zm2.25-9.836a.25.25 0 0 1 .375-.216l3 1.732a.25.25 0 0 1 0 .433l-3 1.732a.25.25 0 0 1-.375-.216zm1.125-1.515c-1.167-.674-2.625.168-2.625 1.515v3.465c0 1.347 1.458 2.189 2.625 1.515l3-1.732c1.167-.673 1.167-2.357 0-3.031z'
				clip-rule='evenodd'
			></path>
		</svg>
	);
...
export const LeaderBoardIcon = ({ h, w, color }: Props) => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			width='32'
...
export const GamedIcon = ({ h, w, color }: Props) => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			width='32'
		...
		>
			<path
				fill='currentColor'
				fill-rule='evenodd'
				d='M12.288 12.41a3.75 3.75 0 0 1 1.373-5.122l6.928-4a3.75 3.75 0 0 1 5.123 1.372l4 6.929a3.75 3.75 0 0 1-1.373 5.122l-6.928 4a3.74 3.74 0 0 1-2.661.42V25A3.75 3.75 0 0 1 15 28.75H7A3.75 3.75 0 0 1 3.25 25v-8A3.75 3.75 0 0 1 7 13.25h5.773zm1.351 2.34H7A2.25 2.25 0 0 0 4.75 17v8A2.25 2.25 0 0 0 7 27.25h8A2.25 2.25 0 0 0 17.25 25v-4.562a3.7 3.7 0 0 1-.962-1.1zm.772-6.163a2.25 2.25 0 0 0-.824 3.073l4 6.929a2.25 2.25 0 0 0 3.074.823l6.928-4a2.25 2.25 0 0 0 .824-3.074l-4-6.928a2.25 2.25 0 0 0-3.074-.823zm3.924 3.796a1.5 1.5 0 1 0-1.5-2.598 1.5 1.5 0 0 0 1.5 2.598m2.5 4.33a1.5 1.5 0 1 0-1.5-2.598 1.5 1.5 0 0 0 1.5 2.598m2.38-8.879a1.5 1.5 0 1 1-2.599 1.5 1.5 1.5 0 0 1 2.598-1.5m1.95 6.38a1.5 1.5 0 1 0-1.5-2.599 1.5 1.5 0 0 0 1.5 2.598M11 22.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3'
				clip-rule='evenodd'
			></path>
		</svg>
	);
